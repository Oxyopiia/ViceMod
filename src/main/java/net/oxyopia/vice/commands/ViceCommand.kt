							...
							.executes {
								...
								try {
									...
									ChatUtils.sendViceMessage(
										UTextComponent("Converted hex ".toText().append(hex.toText(color)).append(" to rgb: ".toText(Colors.ChatColor.Grey)).append("Color(${color.red},${color.green},${color.blue})".toText(color)))
