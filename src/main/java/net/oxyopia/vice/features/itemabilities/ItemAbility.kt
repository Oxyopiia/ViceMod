...
enum class ItemAbility(
    ...
    THE_PHANTASM("The Phantasm", 4f, set = Set.HEAVY, setAmount = 1),
    THE_SYNTHFLESH("The Synthflesh", 3f, set = Set.FLESHCRAWLER, setAmount = 2), // 2 for 1st ability, 3 for 2nd ability
    THE_EXPERIMENT("The Experiment", 6f, set = Set.FLESHCRAWLER, setAmount = 2), // normaly it have 6s under half hp it change to 3s, the set on item its saying 3 but it actually 2 when you are using the item
