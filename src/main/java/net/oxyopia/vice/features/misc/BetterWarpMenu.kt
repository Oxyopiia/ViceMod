...
object BetterWarpMenu {
	...
	private val worlds: List<List<MutableText>> = listOf(
		...
		listOf("Battered Battlefield".toText(Colors.BatteredBattlefield), "Volume".toText(Colors.Volume)),
		...
		listOf("The Oracle".toText(Colors.TheOracle), "Bound to Sin".toText(Colors.BoundToSin))
	)
	private val bosses: List<MutableText> = listOf(
		...
		"Anodized".toText(Colors.Anodized)
	)
